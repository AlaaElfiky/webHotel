        ...
        <div class="bg">
            <div class="main">
                <header>
                    <div class="row-1">
                        <h1>
                            <a class="logo" href="register1.html">REMAA.<span>co</span></a>
                    ...
                    <div class="row-2">
                        <nav>
                            <ul class="menu">
                                ...
                                <li><a class="active" href="about_trip.jsp"> Services</a></li>
                            ...
                            <div class="wrapper indent-bot">
                                <div class="col-3">
                                    <div class="wrapper" style="width: 900px">
                                        ...
                                        <% trip_dbase sharm = new trip_dbase();%>
                                        <% ArrayList <trip> list=sharm.select();%>
                                        
                                        
                                        <% for(int i=0;i<list.size();i++){%>
                                        <div class="extra-wrap">
                                        <figure class="img-indent4"><img style="margin-left: -40px;" width="80" height="70" src="<%= list.get(i).getTrip_path() %> " alt="" /></figure>
                                        <form action="confrm_tripe.jsp"  >
                             
                                    <% session.setAttribute("trip",list.get(i).getTrip_name());%>
                                    <input  type="submit" class="alaa" value="<%=list.get(i).getTrip_name()%>" ><br>
                                
                                </form>
                                            
                                            the trip starts at <a ><%= list.get(i).getTrip_date() %> </a>
                                            and the number of visitors is  <a ><%=list.get(i).getLimit_num() %> </a>
                                            and it's finished at <a ><%=list.get(i).getFinish_date() %> </a>
                                            and we will visit <a ><%=list.get(i).getAbout() %> </a>
                        ...
                        <h2 style="margin-left: 25px">
                               Films
                                        ...
                                        <div class="wrapper" style="width: 900px">
                                            ...
                                            <% ArrayList <films> list_film=sharm.select_flim();%>
                                        
                                        
                                        <% for(int i=0;i<list_film.size();i++){%>
                                        <div class="extra-wrap">
                                            <figure class="img-indent4"><img style="margin-left: -40px;" width="80" height="70" src="<%= list_film.get(i).getPath()%> " alt="" /></figure>
                                            <form action="conf_films.jsp" method="get">
                              
                                
                                
                                    <% session.setAttribute("trip",list_film.get(i).getFilm_name());%>
                                    <input  type="submit" class="alaa" value="<%=list_film.get(i).getFilm_name() %>" ><br>
                                
                                </form>
                                            
                                            the film starts at <a ><%= list_film.get(i).getView_date() %> </a>
                                            and the price of ticket is  <a ><%=list_film.get(i).getPrice()%> </a>
