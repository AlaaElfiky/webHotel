...
<!-- content -->
			<section id="content">
				<div class="padding">
                    ...
                    <ul >
                        ...
                        <li><a href="#">&nbsp;&nbsp;&nbsp;&nbsp;SELECT Trips</a></li>                       
                        <li><a href="#">&nbsp;&nbsp;&nbsp;&nbsp;UPDATE on Trips</a></li>                       
                        <li><a href="#">&nbsp;&nbsp;&nbsp;&nbsp;Delete Trip</a></li>                       
                    </ul>
                </li>
                <hr>
                <li >
		...
		<hr>							
                                            ...
                                            <div class="badge" style="padding: 25px;margin-left: 150px;padding-right: 10px;margin-top: 30px;">
