...
<%@page import="Entity.films"%>
<%@page import="utility.films_dbase"%>
<%@page import="Entity.registed_trip"%>
                                                ...
                                                <table  class="table">
                                                        ...
                                                        <tbody>
                                                            <% films_dbase fil = new films_dbase();
                                                                ArrayList<films> list =fil.select_films();  %>
                                                                
                                                                <% for(int i=0; i<list.size();i++){ %>
                                                       
                                                            <tr>
                                                              
                                                                <td><%= list.get(i).getFilm_name() %></td>
                                                                <td> <%=list.get(i).getView_date() %> </td>
